var NewParser = (function () {
  ...
  var parseString = function (stringParts) {
  ...
  var parseList = function (stringParts) {
    var array = [];
    var start = 1;
    var tokenCount = 1;
  ...
  var parseDict = function (stringParts) {
    var dict = {};
    var start = 1;
    var tokenCount = 1;
    var key;
